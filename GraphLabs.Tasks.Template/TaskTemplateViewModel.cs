...
namespace GraphLabs.Tasks.Template
{
    ...
    public partial class TaskTemplateViewModel : TaskViewModelBase<TaskTemplate>
    {
        ...
        public static readonly DependencyProperty Phase12VisibilityProperty =
            DependencyProperty.Register(
            ExpressionUtility.NameForMember((TaskTemplateViewModel m) => m.Phase12Visibility),
            typeof(Visibility),
            typeof(TaskTemplateViewModel),
            new PropertyMetadata(Visibility.Visible));
        ...
        public static readonly DependencyProperty L1Property =
            DependencyProperty.Register(
                ExpressionUtility.NameForMember((TaskTemplateViewModel m) => m.L1),
                typeof (String),
                typeof (TaskTemplateViewModel),
                new PropertyMetadata("Дополнение"));
        public static readonly DependencyProperty L2Property =
            DependencyProperty.Register(
                ExpressionUtility.NameForMember((TaskTemplateViewModel m) => m.L2),
                typeof(String),
                typeof(TaskTemplateViewModel),
